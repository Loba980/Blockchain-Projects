...
def ethereum_block():
    ...
    gas_price_in_dollar = gas_price_in_ether * 2,520.69
    gas_price_in_rupee = gas_price_in_ether * 156,119.54
    gas_price_in_pound = gas_price_in_ether * 1,481.09
    # Start code for Task 3 below
    value_in_ether["text"] = "Value of gas in ETH: " + str(gas_price_in_ether)
    value_in_dollar["text"] = "Value of gas in CAD " + str(gas_price_in_dollar)
    value_in_rupees["text"] = "Value of gas in INR " + str(gas_price_in_rupee)
    value_in_pounds["text"] = "Value of gas in GBP" + str(gas_price_in_pound)
    search_btn.destroy()
