...
print('Number of blocks in the blockchain: ', Number_of_blocks)

# Write Task 02 code from below
print('Previous hash of the Gensis block: ', blockchain.chain[0]['previous_hash'])
print('Current hash of the Gensis block: ', blockchain.chain[0]['Current_hash'])
print('Previous hash of the 1st block: ', blockchain.chain[1]['previous_hash'])

# Write Task 03 code from below
if blockchain.chain[0]['Current_hash'] == blockchain.chain[1]['previous_hash']:
    print('The previous hash of the last block matches with the current block, hence the transaction is verified.')
else:
    print('Sorry, the previous hash of the last block does not match with the current block, hence the transaction is has been denied.')
