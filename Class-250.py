...
# add the code for chain_valid() function
    def chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            print('The previous nonce of the previous block is: ', previous_nonce)
            print('The current nonce of the current block is: ', current_nonce)
            ...
            print('Encoding of the proof: ', encode_compare_proof)
            hash_compare_proof = encode_compare_proof.hexdigest()
            print('The current block nonce is: ', hash_compare_proof)
