...
#write code here
blockchain = Block()
transaction1 = blockchain.transaction('William', 'Loba', '2 ETH')
transaction2 = blockchain.transaction('Loba', 'William', '4 ETH')
transaction3 = blockchain.transaction('William', 'Bob', '6 ETH')
