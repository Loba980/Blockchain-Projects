...
for increment_block in range(5):
    print('Enter the transaction details of the block- ', increment_block)
    sender = input('Enter the name of the sender: ')
    receiver = input('Enter the name of the receiver: ')
    amount = input('Enter the amount of of the transaction: ')
