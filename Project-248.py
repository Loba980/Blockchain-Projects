...
class Block(object):
    def __init__(self):
        ...
        self.count = 0
        self.new_block(previous_hash="No previous Hash. Since this is the first block.", proof=837)  # Task 01 - Change the value of Proof
...
if blockchain.chain[0]['Current_hash'] == blockchain.chain[1]['previous_hash']:
    print('The proof of work is valid!')
else:
    print('Sorry, the proof of work is not valid...')