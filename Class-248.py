...
# Student code begins
    def proof_of_work(self, previous_proof):
        ...
        while check_proof_condition is False:
            ...
            print('Getting the proof of work: ', hash_proof)
...
print('Previous block proof is: ', previous_proof)

proof = blockchain.proof_of_work(previous_proof)
print('Found proof of work is at: ', proof)

previous_hash = blockchain.hash(previous_block)
print('Previous block hash was: ', previous_hash)

block = blockchain.new_block(proof, previous_hash)

print('The data of the blockchain: ', blockchain.chain)
#Students code ends
